...
computation. In this case the the user must specify a list of magnitude, 
distance pairs. The distance is the value outside which ruptures greater
than the associated magntiude are discarded. An example is shown below:
